    ...
    return (
        <div className={s.container}>
            ...
            <div className={s.wrapper}>
                <Card title={'For Investors & Wholesalers'} description={'Investor\'s Gateway to Lucrative Opportunities'} background={first}/>
                <Card title={'A-to-Z Business Solution'} description={`Launch Your Successful Real Estate Venture \n` +
                    `for Under $300`} background={second}/>
                <Card title={'Hello'} description={'asdasdasdasd dsad as das das d'} background={third}/>
                ...
                <Card title={'Sell for Free'} description={'Begin Marketing Your Property at No Cost and Experience a Seamless Selling Journey'} background={seventh}/>
                <Card title={'Focused Audience Outreach'} description={'Acquire Cost-Effective, Targeted Leads at Unbeatable Prices in The Market'} background={eighth}/>
            </div>
        </div>
    );
};
